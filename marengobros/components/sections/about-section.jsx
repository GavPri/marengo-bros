    ...
    <section id="about" className="relative min-h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 flex min-h-screen w-full flex-col items-center justify-center px-4 py-12 md:flex-row md:items-start md:justify-between md:px-12 lg:px-24">
        ...
        <div className="mb-8 w-full max-w-sm md:mb-0 md:w-1/3 ">
          <div className="overflow-hidden rounded-3xl bg-[#7a7336] text-white shadow-xl pt-4">
            {/* Profile Image with White Border */}
            <div className="mx-auto -mt-1 w-[90%] overflow-hidden rounded-3xl border-4 border-white bg-white">
              <Image
                src="/scott-about.png"
                alt="Scott Marengo"
                width={300}
        ...
        <div className="mb-8 w-full max-w-xs md:mb-0 md:mt-32 md:w-1/4 flex flex-col items-center">
          <div className="overflow-hidden rounded-3xl bg-[#7a7336] p-4 shadow-xl">
            <Logo />
