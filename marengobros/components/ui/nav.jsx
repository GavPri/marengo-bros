...
const navItems = [
  ...
  { label: "Custom Writing", href: "/custom-writings" },
      ...
      <div className="fixed bottom-20 left-1/2 transform -translate-x-1/2 z-50 sm:hidden">
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetTrigger asChild>
            <button className="flex items-center justify-center w-14 h-14 rounded-full backdrop-blur-md shadow-lg border-2 border-gray-50">
              <Menu className="h-6 w-6 text-white" />
              <span className="sr-only">Open navigation menu</span>
            </button>
          </SheetTrigger>
          <SheetContent side="bottom" className="rounded-t-3xl backdrop-opacity-50 backdrop-blur-md border-gray-50 pt-6 pb-10">
